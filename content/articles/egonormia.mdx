...
image:
  ...
  alt: Example EgoNormia question
  caption: An example question from EgoNormia.
authors:
...
Machines lack explicit norm understanding in physical and social contexts. We present <span style={{ fontVariant: "small-caps" }}>EgoNormia</span> <Math> ||\epsilon|| </Math>, featuring 1,853 ego-centric videos with questions testing prediction and justification of normative actions across seven categories: <span style={{ color: "#246D63" }}>safety</span>, <span style={{ color: "#356ABC" }}>politeness</span>, <span style={{ color: "#5C4C99" }}>privacy</span>, <span style={{ color: "#D87CA6" }}>proxemics</span>, <span style={{ color: "#C65B4E" }}>cooperation</span>, <span style={{ color: "#EA772F" }}>communication/legibility</span>, and <span style={{ color: "#E6A700" }}>coordination/proactivity</span>. Our novel pipeline includes video sampling, automatic answer generation, filtering, and human validation. State-of-the-art vision-language models score only 45% on <span style={{ fontVariant: "small-caps" }}>EgoNormia</span> versus humans' 92%. Analysis reveals critical gaps in <span style={{ color: "#246D63" }}>safety</span>, <span style={{ color: "#5C4C99" }}>privacy</span>, <span style={{ color: "#C65B4E" }}>cooperation</span>, and <span style={{ color: "#EA772F" }}>communication/legibility</span> for real-world applications. We demonstrate <span style={{ fontVariant: "small-caps" }}>EgoNormia</span> can enhance normative reasoning in VLMs through retrieval-based generation.
<VideoVisualizer />
...
<div className="flex justify-center items-center w-full my-8">
  <div className="w-full overflow-x-auto" style={{ minWidth: "800px" }}>
    <table className="w-full border-collapse text-xl" style={{ tableLayout: "fixed" }}>
      ...
      <tbody>
        ...
        <tr className="bg-gray-100 dark:bg-gray-800">
          <td colSpan="6" className="py-3 px-4 font-semibold text-gray-800">Blind Models - Closed Source</td>
        </tr>
        <tr className="border-b border-gray-200">
        ...
        <tr className="bg-gray-100 dark:bg-gray-800">
          <td colSpan="6" className="py-3 px-4 font-semibold text-gray-800">Blind Models - Open Source</td>
        </tr>
        <tr className="border-b border-gray-200">
        ...
        <tr className="bg-gray-100 dark:bg-gray-800">
          <td colSpan="6" className="py-3 px-4 font-semibold text-gray-800">Pipeline Models - Closed Source</td>
        </tr>
        <tr className="border-b border-gray-200">
        ...
        <tr className="bg-gray-100 dark:bg-gray-800">
          <td colSpan="6" className="py-3 px-4 font-semibold text-gray-800">Pipeline Models - Open Source</td>
        </tr>
        <tr className="border-b border-gray-200">
        ...
        <tr className="bg-gray-100 dark:bg-gray-800">
          <td colSpan="6" className="py-3 px-4 font-semibold text-gray-800">Video Models - Closed Source</td>
        </tr>
        <tr className="border-b border-gray-200">
        ...
        <tr className="bg-gray-100 dark:bg-gray-800">
          <td colSpan="6" className="py-3 px-4 font-semibold text-gray-800">Video Models - Open Source</td>
        </tr>
        <tr className="border-b border-gray-200">
        ...
        <tr className="bg-gray-100 dark:bg-gray-800">
          <td colSpan="6" className="py-3 px-4 font-semibold text-gray-800">Human</td>
        </tr>
    ...
    <p className="text-left text-lg mt-4 max-w-4xl mx-auto">
