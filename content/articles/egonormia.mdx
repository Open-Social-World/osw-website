...
<Link className="w-full" href="https://huggingface.co/datasets/open-social-world/EgoNormia">
...
<Link className="w-full" href="https://github.com/Open-Social-World/EgoNormia">
...
<Link className="w-full" href="https://arxiv.org/abs/2305.17008">
...
<Link className="w-full" href="/people">
