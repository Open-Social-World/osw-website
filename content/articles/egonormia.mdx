...
<Callout icon="🍃">
    With EgoNormia, we ask whether current AI models can perform normative reasoning in physical and social contexts.
    To create this benchmark, we propose an efficient pipeline to gather human consensus on normative actions under
...
<Callout icon="💡">
    We also propose a retrieval-based approach to enable in-context learning of normative reasoning in VLMs, which is
