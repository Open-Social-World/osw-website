...
<div className="flex justify-center gap-4">
  <a
    href="/leaderboard"
    className="inline-flex items-center gap-2 px-8 py-3 bg-primary text-primary-foreground rounded-lg text-xl font-semibold hover:bg-primary/90 transition-colors"
  >
...
<div className="bg-gray-100 dark:bg-gray-800 py-8 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8">
  <VideoVisualizer />
</div>
